...
var TextChannel = /** @class */ (function (_super) {
     ...
     *
     */
    TextChannel.prototype.send = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(this.id);
                        return [4 /*yield*/, (0, undici_1.fetch)("https://discord.com/api/v10/channels/".concat(this.id, "/messages"), {
                                body: JSON.stringify({
                                    content: "Hello, World!"
                                }),
                                headers: {
